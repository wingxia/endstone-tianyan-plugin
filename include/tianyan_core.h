...
inline unsigned int mysql_port_number = 3306;
inline string mysql_user = "tianyan";
inline string mysql_password = "tianyan";
inline string mysql_database = "tianyan";
inline yuhangle::MysqlConfig mysql_config{mysql_host, mysql_user, mysql_password, mysql_database, mysql_port_number};
//配置变量
